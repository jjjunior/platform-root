...
public final class CorsSettings {
	...
	public void setAllowedHeaders(List<String> allowedHeaders) { this.allowedHeaders = List.copyOf(allowedHeaders); }
	public List<String> getAllowedMethods() { return allowedMethods; }
	public void setAllowedMethods(List<String> allowedMethods) { this.allowedMethods = List.copyOf(allowedMethods); }
